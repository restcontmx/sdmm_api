    ...
    public class TipoProductoController : BasicApiController
    {
        ...
        public HttpResponseMessage list()
        {
            try
            {
                ...
                data.Add("data", tipoproducto_service.getAll());
        ...
        {
            TipoProducto tipoproducto = tipoproducto_service.detail(id);
        ...
        {
            TransactionResult tr = tipoproducto_service.create(tipoproducto_vo, new Models.Auth.User { id = int.Parse(RequestContext.Principal.Identity.Name) });
            IDictionary<string, string> data = new Dictionary<string, string>();
        ...
        {
            TransactionResult tr = tipoproducto_service.update(tipoproducto_vo);
            IDictionary<string, string> data = new Dictionary<string, string>();
        ...
        {
            TransactionResult tr = tipoproducto_service.delete(id);
            IDictionary<string, string> data = new Dictionary<string, string>();
